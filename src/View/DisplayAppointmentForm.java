...
public class DisplayAppointmentForm extends javax.swing.JFrame {

    /**
     * Creates new form DisplayAppointmentForm
     */
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(1327, 1236));
    ...
    private void BackbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BackbtnActionPerformed
        try {
            ...
            Logger.getLogger(DisplayAppointmentForm.class.getName()).log(Level.SEVERE, null, ex);
        }
        dispose();
    ...
    private void DeletebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeletebtnActionPerformed
        ...
        int AppointmentNo = Integer.parseInt(jTable1.getValueAt(row, 0).toString());

        int Choice = JOptionPane.showConfirmDialog(this, "Delete Patient Appointment?", "Delete Confirmation", JOptionPane.YES_NO_OPTION);

        if(Choice == JOptionPane.YES_OPTION){
            AppointmentDAO dao = new AppointmentDAO();

            if(dao.DeleteAppointment(AppointmentNo)){
                JOptionPane.showMessageDialog(this, "Patient Appointment Deleted");
                getAllAppointments();
            }
            }
    ...
    try {
        ...
        java.util.logging.Logger.getLogger(DisplayAppointmentForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
