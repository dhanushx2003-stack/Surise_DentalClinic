...
public class AppointmentControllerTest {
    ...
    public void testValidAppoitmentRegistration() {
        String result = controller.RegisterAppointment("317", "Ben Kinglsy", "Negombo", "0775854128", "Dr. Wilson", "2026-02-11", "10:00 AM");

        System.out.println();
        System.out.println("Test 1 Appointment Registration");
        System.out.println("Appointment Number: 317");
        System.out.println("Patient Name: Ben Kinglsy");
        System.out.println("Address: Negombo");
        System.out.println("Contact Number: 0775854128");
        System.out.println("Dentist Name: Dr. Wilson");
        System.out.println("Appointment Date: 2026-02-11");
    ...
    public void testInvalidAppointmentNumber() {
        String result = controller.RegisterAppointment("A11", "Ben Kinglsy", "Negombo", "0775854128", "Dr. Wilson", "2026-02-11", "10:00 AM");
    ...
    public void testDeuplicateAppointmentNumber() {
        String result = controller.RegisterAppointment("311", "Ben Kinglsy", "Negombo", "0775854128", "Dr. Wilson", "2026-02-11", "10:00 AM");
        String result2 = controller.RegisterAppointment("311", "Ben Kinglsy", "Negombo", "0775854128", "Dr. Wilson", "2026-02-11", "10:00 AM");

        System.out.println();
        System.out.println("Test 4 Duplicate Appointment Number");
        System.out.println("Appointment Number: 311");
        System.out.println("Appointment Number: 311");
    ...
    public void testNoPatientName() {
        String result = controller.RegisterAppointment("312", "", "Colombo", "0774125632", "Dr. Christine", "2026-05-12", "10:30 AM");

        System.out.println();
        System.out.println("Test 5 No Patient Name");
        System.out.println("Appointment Number: 312");
        System.out.println("Patient Name: ");
        ...
        System.out.println("Expected Result: Enter Patient Name");
        System.out.println("Actual Result: " + result);
        assertEquals("Empty Fields", result);
    ...
    public void testNoAddress() {
        String result = controller.RegisterAppointment("313", "Mark Henry", "", "0775231568", "Dr. Wilson", "2026-08-14", "10:25 AM");
        
        System.out.println();
        System.out.println("Test 6 No Address");
        System.out.println("Appointment Number: 313");
        ...
        System.out.println("Expected Result: Enter Address");
        System.out.println("Actual Result: " + result);
        assertEquals("Empty Fields", result);
    ...
    public void testNoContactNumber(){
        ...
        String result = controller.RegisterAppointment("314", "Jack Ryan", "Dehiwela", "", "Dr. Marian", "2026-07-07", "08:00 AM");
        
        System.out.println();
        System.out.println("Test 7 No Contact Number");
        System.out.println("Appointment Number: 314");
        System.out.println("Patient Name: Jack Ryan");
        System.out.println("Address: Dehiwala");
        System.out.println("Contact Number: ");
        ...
        System.out.println("Expected Result: Enter Contact Number");
        System.out.println("Actual Result: " + result);
        assertEquals("Empty Fields", result);
    ...
    public void testNoAppointmentDate(){
        String result = controller.RegisterAppointment("315", "Sanduni Perera", "Thaladuwa", "0774123256", "Dr. Marian", "", "08:30 PM");
        
        System.out.println();
        System.out.println("Test 8 No Appointment Date");
        System.out.println("Appointment Number: 315");
        ...
        System.out.println("Expected Result: Enter Appointment Date");
        System.out.println("Actual Result: " + result);
        assertEquals("Empty Fields", result);
    ...
    public void testNoAppointmentTime(){
        String result = controller.RegisterAppointment("316", "Mary Watson", "Maradana", "0778523698", "Dr. Joseph", "2026-12-01", "");
        
        System.out.println();
        System.out.println("Test 9 No Appointment Time");
        System.out.println("Appointment Number: 316");
        ...
        System.out.println("Appointment Time: ");
        System.out.println("Expected Result: Enter Appointment Time");
        System.out.println("Actual Result: " + result);
        assertEquals("Empty Fields", result);
